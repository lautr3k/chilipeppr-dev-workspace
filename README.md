...
| Github URL            | http://github.com/lautr3k/chilipeppr-dev-workspace |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/lautr3k/chilipeppr-dev-workspace/master/auto-generated-workspace.html",
  function() {
    ...
    cprequire(
      ...
      function(myDevWorkspace) {
        ...
        console.log("Dev. Workspace. just got loaded.", myDevWorkspace);
        myDevWorkspace.init();
      }
    );
  }
...
follows the standard template for workspace pulldown menus.</td></tr><tr valign="top"><td>setupResize</td><td>function</td><td>function () <br><br>Listen to window resize event.</td></tr><tr valign="top"><td>onResize</td><td>function</td><td>function () <br><br>When browser window resizes, forcibly resize the Console window</td></tr><tr valign="top"><td>load3DViewer</td><td>function</td><td>function (callback) <br><br>Load the Meshes widget via chilipeppr.load() so folks have a sample
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadMeshesWidget</td><td>function</td><td>function (callback) <br><br>Load the Meshes widget via chilipeppr.load() so folks have a sample
