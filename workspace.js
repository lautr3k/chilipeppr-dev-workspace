...
cprequire_test(["inline:com-chilipeppr-dev-workspace"], function(ws) {
...
cpdefine("inline:com-chilipeppr-dev-workspace", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-dev-workspace", // Make the id the same as the cpdefine id
        name: "Dev. Workspace.", // The descriptive name of your widget.
